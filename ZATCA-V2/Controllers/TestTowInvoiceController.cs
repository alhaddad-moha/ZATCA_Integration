...
namespace ZATCA_V2.Controllers
{
    ...
    [ApiController]
    public class TestTowInvoiceController : ControllerBase
    {
        /*
        ...
        public async Task<IActionResult> Generate()
        {
            ...
            if (inv.invoiceTypeCode.id == 383 || inv.invoiceTypeCode.id == 381)
            {
                ...
                invoiceDocumentReference.ID = "12345"; // mandatory in case of return sales invoice or debit notes
